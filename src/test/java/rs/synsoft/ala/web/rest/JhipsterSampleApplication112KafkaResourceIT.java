package rs.synsoft.ala.web.rest;
...
import rs.synsoft.ala.config.KafkaProperties;

class JhipsterSampleApplication112KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplication112KafkaResource kafkaResource = new JhipsterSampleApplication112KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-112-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-112-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
