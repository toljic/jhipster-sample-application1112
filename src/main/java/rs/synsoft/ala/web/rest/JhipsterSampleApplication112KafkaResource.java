...
@RestController
@RequestMapping("/api/jhipster-sample-application-112-kafka")
public class JhipsterSampleApplication112KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplication112KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplication112KafkaResource(KafkaProperties kafkaProperties) {
